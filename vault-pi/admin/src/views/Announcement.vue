      ...
      <div class="table-container">
        <table>
          ...
          <tbody>
            ...
            <tr v-for="a in list" :key="a.id" :class="{ 'row-top': a.isTop === '0' }">
              <td>{{ a.id }}</td>
              <td>
                <span v-if="a.isTop === '0'" class="badge badge-warning">置顶</span>
              ...
              <td class="action-cell">
                ...
                <button class="btn-text" @click="toggleTop(a)">{{ a.isTop === '0' ? '取消置顶' : '置顶' }}</button>
...
.col-title { font-weight: 500; color: #2d3748; max-width: 400px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.lang-tag { background: #ebf8ff; color: #2b6cb0; padding: 2px 6px; border-radius: 4px; font-size: 11px; font-weight: 700; }
...
.modal-content { background: #fff; border-radius: 12px; width: 800px; max-width: 90%; max-height: 90vh; display: flex; flex-direction: column; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.1); }
